...
import ProOF.apl.UAV.gen.linear.LinearPlotState;
...
public class LinearParticleControl {
    ...
    private final pLinearControlUncertainty uncU;
    private final oLinearDynamic dynamic;

    private final LinearPlotState states[];

    
    public LinearParticleControl(pLinearStateUncertainty unc, pLinearControlUncertainty uncU, oLinearDynamic dynamic, LinearState[] states, LinearControl[] controls) throws Exception {
        this.unc = unc;
        this.uncU = uncU;
