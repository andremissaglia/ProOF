...
public class LinearPlotState {
    ...
    public void fillRect(Graphics2DReal gr, Color color, double r){
        gr.setColor(color);
        gr.fillRectR(x[0], x[1], r, r);
    }
    public void drawLabel(Graphics2DReal gr, Color color, double r){
        gr.setColor(color);
        gr.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, gr.unit(r*4)));
        if(x.length==6){
    ...
    public void drawRiskAllocation(Graphics2DReal gr, pLinearStateUncertainty unc, double delta, Color color, Obstacle ...obs) throws Exception{
    ...
    public void drawRiskAllocation(Graphics2DReal gr, pLinearStateUncertainty unc, double delta, Color color) throws Exception{
