...
public abstract class Plot extends Approach{
    ...
    public void goTo(Rectangle2D rect, double offset){
        draw.goTo(rect.getX() - rect.getWidth()*offset, rect.getY()-rect.getHeight()*offset, rect.getWidth()*(1+2*offset), rect.getHeight()*(1+2*offset));
    }
