...
public class CplexNumScalProd {
    ...
    public CplexNumScalProd(CplexExtended cplex, String name, int N, final double MAX, IloNumExpr ...exp) throws IloException {
        this(cplex, name, N, MAX, 1.0, exp);
    }
    public CplexNumScalProd(CplexExtended cplex, String name, int N, final double MAX, final double coef, IloNumExpr ...exp) throws IloException {
        if(MAX<0){
